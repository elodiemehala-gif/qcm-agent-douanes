...
</style></head><body><div class="wrap"><header><h1>Raisonnement logique — banque à valider</h1><p class="muted">180 QCM de méthode et 60 familles d’exercices variables. Rien n’est encore intégré à l’application.</p><div class="stats"><span class="tag">180 questions</span><span class="tag">60 familles</span><span class="tag">6 chapitres</span></div></header><div class="panel"><div class="tabs"><button class="tab on" data-view="questions">180 questions</button><button class="tab" data-view="families">60 familles d’exercices</button></div><input id="search" type="search" placeholder="Rechercher une notion, un piège ou un mot-clé"><div class="filters"><button class="filter on" data-ch="">Tous les chapitres</button>${Object.values(chapters).map(ch=>`<button class="filter" data-ch="${ch.id}">${ch.title}</button>`).join('')}</div></div><main id="content"></main></div><script src="logic-180-bank.js"></script><script src="logic-60-families.js"></script><script>
