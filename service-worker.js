const CACHE='qcm-agent-douanes-v7';
const ASSETS=[
  './','./index.html','./v2.html','./style-v2.css','./qcm-v4.css','./helper.js','./engine-math.js','./engine-logic.js','./knowledge-engine.js','./chapter-map.js','./knowledge-chapter-engine.js','./math-course-links.js','./app-v5.js','./cours-maths.html','./manifest.webmanifest','./icon-192.svg','./icon-512.svg',
